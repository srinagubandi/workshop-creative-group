...
const INDUSTRIES = [
  "Retail","Healthcare","Hospitality","Manufacturing","Real Estate","Construction",
  "Automotive","Education","Government","Financial Services","Events & Trade Shows",
    ...
    >
      ...
      <section className="relative overflow-hidden bg-hero-gradient min-h-screen flex items-center" aria-labelledby="hero-heading">
        <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
          ...
          <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full blur-3xl" style={{ background: "rgba(125,190,49,0.08)" }} />
        </div>
        <div className="container relative z-10 py-32 md:py-40">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up animate-delay-400">
              ...
              <Link href="/about" className="btn-ghost-white text-base px-8 py-4">Explore Services</Link>
            </div>
      ...
      <section className="section-py bg-white" aria-labelledby="process-heading">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 id="process-heading" className="text-heading text-3xl md:text-4xl text-gray-900 mb-4">See Your Savings in Two Simple Steps</h2>
            <p className="text-gray-500 max-w-xl mx-auto">No guesswork, no commitments. A clear comparison showing exactly how much you can save.</p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 id="about-preview-heading" className="text-heading text-3xl md:text-4xl text-gray-900 mb-4">Print Experience Backed by Creative Thinking</h2>
      ...
      <section className="section-py bg-white" aria-labelledby="services-heading">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 id="services-heading" className="text-heading text-3xl md:text-4xl text-gray-900 mb-4">Complete Print and Creative Solutions</h2>
            <p className="text-gray-500 max-w-2xl mx-auto">From large format graphics and branding support to commercial print sourcing — easier, more strategic, more cost-effective.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 stagger-children">
            {SERVICES.map((service) => (
              <Link key={service.href} href={service.href} className="service-card group block">
                ...
                <span className="inline-flex items-center gap-1.5 text-sm font-semibold group-hover:gap-2.5 transition-all duration-200"
                      style={{ color: service.learnColor }}>
                  Learn More
      ...
      <section className="section-py bg-gray-50" aria-labelledby="why-heading">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 id="why-heading" className="text-heading text-3xl md:text-4xl text-gray-900 mb-4">Why Businesses Choose Workshop Creative Group</h2>
            <p className="text-gray-500 max-w-2xl mx-auto">From competitive pricing to dependable turnaround, here's what sets us apart.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 stagger-children">
            {WHY_US.map((item) => (
              <div key={item.title} className="rounded-2xl p-6 border flex gap-4"
      ...
      <section className="section-py bg-white" aria-labelledby="industries-heading">
        <div className="container">
          <div className="text-center mb-10">
            ...
            <h2 id="industries-heading" className="text-heading text-3xl md:text-4xl text-gray-900 mb-4">Industries We Serve</h2>
            <p className="text-gray-500 max-w-2xl mx-auto">Workshop Creative Group works with businesses across a wide range of industries, delivering tailored print and design solutions for every environment.</p>
          </div>
