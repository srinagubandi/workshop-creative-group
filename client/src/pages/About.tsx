                ...
                <ul className="space-y-4 list-none m-0 p-0">
                  {VALUES.map((value) => (
                    <li key={value} className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: '#1261ae' }}>
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                {[
                  ...
                  <div key={stat.label} className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm text-center">
                    <div className="text-3xl font-serif font-bold mb-1" style={{ color: '#1261ae' }}>{stat.num}</div>
