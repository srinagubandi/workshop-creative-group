 ...
 * Brent's Blog hidden from nav (page still exists at /blog).
    ...
    <>
      ...
      >
        <div className="container">
          <nav className="flex items-center h-16 md:h-20" aria-label="Main navigation">
